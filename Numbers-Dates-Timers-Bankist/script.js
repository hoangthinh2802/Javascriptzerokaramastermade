...
// console.log(new Date('Mar 18 2021 19:49:12'));
// console.log(new Date('December 24, 2015'));
// console.log(new Date(account1.movementsDates[0]));
// console.log(new Date(2014, 10, 17, 14, 34, 52));
// console.log(new Date(2021, 12, 31));

// console.log(new Date(0));
// console.log(new Date(3 * 24 * 60 * 50 * 1000));
...
// console.log(future);
// const future = new Date(2024, 10, 14, 14, 15, 23);
// console.log(+future);

// const day1 = calcDayPassed(new Date(2037, 3, 14), new Date(2037, 6, 13));
